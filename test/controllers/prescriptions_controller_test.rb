...
class PrescriptionsControllerTest < ActionController::TestCase
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post :create, prescription: { drug_id: @prescription.drug_id, prescribed_at: @prescription.prescribed_at, quantity: @prescription.quantity, quantity: @prescription.quantity, user_id: @prescription.user_id }
    end
  ...
  test "should update prescription" do
    patch :update, id: @prescription, prescription: { drug_id: @prescription.drug_id, prescribed_at: @prescription.prescribed_at, quantity: @prescription.quantity, quantity: @prescription.quantity, user_id: @prescription.user_id }
    assert_redirected_to prescription_path(assigns(:prescription))
  end
